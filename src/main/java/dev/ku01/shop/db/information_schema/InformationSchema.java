 ...
 */
package dev.ku01.shop.db.information_schema;


import dev.ku01.shop.db.DefaultCatalog;
import dev.ku01.shop.db.information_schema.tables.AdministrableRoleAuthorizations;
import dev.ku01.shop.db.information_schema.tables.ApplicableRoles;
import dev.ku01.shop.db.information_schema.tables.Attributes;
import dev.ku01.shop.db.information_schema.tables.CharacterSets;
import dev.ku01.shop.db.information_schema.tables.CheckConstraintRoutineUsage;
import dev.ku01.shop.db.information_schema.tables.CheckConstraints;
import dev.ku01.shop.db.information_schema.tables.CollationCharacterSetApplicability;
import dev.ku01.shop.db.information_schema.tables.Collations;
import dev.ku01.shop.db.information_schema.tables.ColumnColumnUsage;
import dev.ku01.shop.db.information_schema.tables.ColumnDomainUsage;
import dev.ku01.shop.db.information_schema.tables.ColumnOptions;
import dev.ku01.shop.db.information_schema.tables.ColumnPrivileges;
import dev.ku01.shop.db.information_schema.tables.ColumnUdtUsage;
import dev.ku01.shop.db.information_schema.tables.Columns;
import dev.ku01.shop.db.information_schema.tables.ConstraintColumnUsage;
import dev.ku01.shop.db.information_schema.tables.ConstraintTableUsage;
import dev.ku01.shop.db.information_schema.tables.DataTypePrivileges;
import dev.ku01.shop.db.information_schema.tables.DomainConstraints;
import dev.ku01.shop.db.information_schema.tables.DomainUdtUsage;
import dev.ku01.shop.db.information_schema.tables.Domains;
import dev.ku01.shop.db.information_schema.tables.ElementTypes;
import dev.ku01.shop.db.information_schema.tables.EnabledRoles;
import dev.ku01.shop.db.information_schema.tables.ForeignDataWrapperOptions;
import dev.ku01.shop.db.information_schema.tables.ForeignDataWrappers;
import dev.ku01.shop.db.information_schema.tables.ForeignServerOptions;
import dev.ku01.shop.db.information_schema.tables.ForeignServers;
import dev.ku01.shop.db.information_schema.tables.ForeignTableOptions;
import dev.ku01.shop.db.information_schema.tables.ForeignTables;
import dev.ku01.shop.db.information_schema.tables.InformationSchemaCatalogName;
import dev.ku01.shop.db.information_schema.tables.KeyColumnUsage;
import dev.ku01.shop.db.information_schema.tables.Parameters;
import dev.ku01.shop.db.information_schema.tables.ReferentialConstraints;
import dev.ku01.shop.db.information_schema.tables.RoleColumnGrants;
import dev.ku01.shop.db.information_schema.tables.RoleRoutineGrants;
import dev.ku01.shop.db.information_schema.tables.RoleTableGrants;
import dev.ku01.shop.db.information_schema.tables.RoleUdtGrants;
import dev.ku01.shop.db.information_schema.tables.RoleUsageGrants;
import dev.ku01.shop.db.information_schema.tables.RoutineColumnUsage;
import dev.ku01.shop.db.information_schema.tables.RoutinePrivileges;
import dev.ku01.shop.db.information_schema.tables.RoutineRoutineUsage;
import dev.ku01.shop.db.information_schema.tables.RoutineSequenceUsage;
import dev.ku01.shop.db.information_schema.tables.RoutineTableUsage;
import dev.ku01.shop.db.information_schema.tables.Routines;
import dev.ku01.shop.db.information_schema.tables.Schemata;
import dev.ku01.shop.db.information_schema.tables.Sequences;
import dev.ku01.shop.db.information_schema.tables.SqlFeatures;
import dev.ku01.shop.db.information_schema.tables.SqlImplementationInfo;
import dev.ku01.shop.db.information_schema.tables.SqlParts;
import dev.ku01.shop.db.information_schema.tables.SqlSizing;
import dev.ku01.shop.db.information_schema.tables.TableConstraints;
import dev.ku01.shop.db.information_schema.tables.TablePrivileges;
import dev.ku01.shop.db.information_schema.tables.Tables;
import dev.ku01.shop.db.information_schema.tables.Transforms;
import dev.ku01.shop.db.information_schema.tables.TriggeredUpdateColumns;
import dev.ku01.shop.db.information_schema.tables.Triggers;
import dev.ku01.shop.db.information_schema.tables.UdtPrivileges;
import dev.ku01.shop.db.information_schema.tables.UsagePrivileges;
import dev.ku01.shop.db.information_schema.tables.UserDefinedTypes;
import dev.ku01.shop.db.information_schema.tables.UserMappingOptions;
import dev.ku01.shop.db.information_schema.tables.UserMappings;
import dev.ku01.shop.db.information_schema.tables.ViewColumnUsage;
import dev.ku01.shop.db.information_schema.tables.ViewRoutineUsage;
import dev.ku01.shop.db.information_schema.tables.ViewTableUsage;
import dev.ku01.shop.db.information_schema.tables.Views;
import dev.ku01.shop.db.information_schema.tables._PgExpandarray;
import dev.ku01.shop.db.information_schema.tables._PgForeignDataWrappers;
import dev.ku01.shop.db.information_schema.tables._PgForeignServers;
import dev.ku01.shop.db.information_schema.tables._PgForeignTableColumns;
import dev.ku01.shop.db.information_schema.tables._PgForeignTables;
import dev.ku01.shop.db.information_schema.tables._PgUserMappings;
import dev.ku01.shop.db.information_schema.tables.records._PgExpandarrayRecord;
...
public class InformationSchema extends SchemaImpl {
    ...
    public static Result<_PgExpandarrayRecord> _PG_EXPANDARRAY(
        ...
        return configuration.dsl().selectFrom(dev.ku01.shop.db.information_schema.tables._PgExpandarray._PG_EXPANDARRAY.call(
              __1
        )).fetch();
    }
    ...
    public static _PgExpandarray _PG_EXPANDARRAY(
        ...
        return dev.ku01.shop.db.information_schema.tables._PgExpandarray._PG_EXPANDARRAY.call(
            __1
        );
    }
    ...
    public final List<Domain<?>> getDomains() {
        return Arrays.asList(
            dev.ku01.shop.db.information_schema.Domains.CARDINAL_NUMBER,
            dev.ku01.shop.db.information_schema.Domains.CHARACTER_DATA,
            dev.ku01.shop.db.information_schema.Domains.SQL_IDENTIFIER,
            dev.ku01.shop.db.information_schema.Domains.TIME_STAMP,
            dev.ku01.shop.db.information_schema.Domains.YES_OR_NO
        );
    }
