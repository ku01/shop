...
public class PgStatisticExtData extends TableImpl<PgStatisticExtDataRecord> {
     ...
     */
    public final TableField<PgStatisticExtDataRecord, PgStatisticRecord[]> STXDEXPR = createField(DSL.name("stxdexpr"), dev.ku01.shop.db.pg_catalog.tables.PgStatistic.PG_STATISTIC.getDataType().array(), this, "");
